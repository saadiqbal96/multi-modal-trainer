...
async def moderate_audio(
    ...
    """
    Moderate an audio file using the configured PydanticAI agent and return a structured result.
    """
    audio_input = BinaryContent(
        data=audio_source,
        media_type=media_type,
    )

    prompt = "Please analyze the following audio for transcription and moderation."
