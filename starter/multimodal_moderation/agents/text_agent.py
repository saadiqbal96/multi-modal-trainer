...
# Pydantic AI agent for text moderation
...
async def moderate_text(model_choice: ModelChoice, text: str) -> TextModerationResult:
    """
    Moderate a piece of text using the configured PydanticAI agent and return a structured result.
    """
    prompt = f"Message to review:\n{text}"
